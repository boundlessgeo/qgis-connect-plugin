...
<qgis projectname="" version="2.18.10">
  ...
  <layer-tree-group expanded="1" checked="Qt::Checked" name="">
    <customproperties/>
    <!--layer-tree-layer expanded="1" checked="Qt::Unchecked" id="bluemarble20170322195242226" name="bluemarble">
      <customproperties/>
  </layer-tree-layer-->
    #LAYER_TREE_LAYER#
</layer-tree-group>
  ...
  <mapcanvas>
    ...
    <extent>
      ...
      <ymin>-17665183.74920467659831047</ymin>
      <xmax>21039383.75992871448397636</xmax>
      <ymax>17665183.74920468404889107</ymax>
    </extent>
    <rotation>0</rotation>
    ...
    <layer_coordinate_transform_info>
      <!--layer_coordinate_transform destAuthId="EPSG:3857" srcAuthId="EPSG:3857" srcDatumTransform="-1" destDatumTransform="-1" layerid="alayer20170322140634990"/-->
      #LAYER_COORDINATE_TRANSFORM#
    </layer_coordinate_transform_info>
  </mapcanvas>
  <layer-tree-canvas>
    <custom-order enabled="0">
      <!--item>alayer20170322140634990</item-->
      #CUSTOM_ORDER#
    </custom-order>
  </layer-tree-canvas>
  ...
  <properties>
    ...
    <Gui>
      <SelectionColorBluePart type="int">4</SelectionColorBluePart>
